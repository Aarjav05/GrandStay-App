...
const styles = StyleSheet.create({
  ...
  filterTitle: { fontSize: FONT_SIZES.xl, fontFamily: 'Inter_700Bold', textAlign: 'center', marginBottom: SPACING.lg },
  filterLabel: { fontSize: FONT_SIZES.md, fontFamily: 'Inter_600SemiBold', marginBottom: SPACING.sm },
